        ...
        <section id="projects" className="min-h-screen p-6 sm:p-12 lg:p-24 bg-zinc-950/30">
          ...
          <div className="grid gap-8 sm:gap-16">
            {PROJECTS_DATA.map((project) => (
              <div key={project.id} className="group relative bg-zinc-900/40 rounded-[2rem] sm:rounded-[3rem] border border-white/5 p-6 sm:p-10 lg:p-14 transition-all hover:bg-zinc-900/60 overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="space-y-16 sm:space-y-32">
              {EXPERIENCE_DATA.map((exp, i) => (
                <div key={i} className={`flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-0 ${i % 2 === 0 ? 'lg:flex-row-reverse' : ''}`}>
        ...
        <section id="achievements" className="min-h-screen p-6 sm:p-12 lg:p-24 flex flex-col justify-center bg-zinc-950/30">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {ACHIEVEMENTS_DATA.map((ach, i) => (
              <div key={i} className="bg-zinc-900/50 p-8 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] border border-white/5 flex flex-col items-center text-center group hover:bg-zinc-900 transition-all">
